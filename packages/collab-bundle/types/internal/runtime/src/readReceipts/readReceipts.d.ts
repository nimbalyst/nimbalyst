 ...
 *   suppressed as "mine".
 */
export declare function isEntityUnread(snapshot: UnreadEntitySnapshot, receipt: ReadReceipt | null | undefined, currentActorId: string | null | undefined): boolean;
/**
 ...
 */
export declare function mergeReceipt(existing: ReadReceipt | null | undefined, incoming: ReadReceipt): ReadReceipt;
/**
 ...
 */
export declare function receiptAdvances(existing: ReadReceipt | null | undefined, incoming: ReadReceipt): boolean;
