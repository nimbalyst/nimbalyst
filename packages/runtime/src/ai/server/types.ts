 ...
 */
export const AI_PROVIDER_TYPES = ['claude', 'claude-code', 'claude-code-cli', 'openai', 'openrouter', 'featherless', 'featherless-official', 'featherless-sane', 'featherless-heretic', 'featherless-keyword', 'openai-codex', 'openai-codex-acp', 'lmstudio', 'opencode', 'copilot-cli'] as const;

export type AIProviderType = typeof AI_PROVIDER_TYPES[number];

export const OPENAI_COMPATIBLE_PROVIDER_TYPES = ['openai', 'openrouter', 'featherless', 'featherless-official', 'featherless-sane', 'featherless-heretic', 'featherless-keyword'] as const;
