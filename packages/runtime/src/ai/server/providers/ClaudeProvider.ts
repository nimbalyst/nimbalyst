...
export class ClaudeProvider extends BaseAIProvider {
   ...
   * `claude-3-*` Opus model -- still accepts `temperature`. Claude Fable 5
   * follows the Opus 4.7+ adaptive-thinking path and rejects sampling params.
   *
  ...
  static supportsTemperature(modelId: string | undefined): boolean {
    ...
    if (id === 'claude-fable-5' || id.startsWith('claude-fable-5-')) {
      return false;
    }
