  ...
  return (
    <div className="provider-panel flex flex-col">
      <div className="provider-panel-header mb-6 pb-4 border-b border-[var(--nim-border)]">
        <h3 className="provider-panel-title text-xl font-semibold leading-tight mb-2 text-[var(--nim-text)]">Synthetic.new</h3>
        <p className="provider-panel-description text-sm leading-relaxed text-[var(--nim-text-muted)]">
          Access to open-weight models (Llama, Qwen, DeepSeek, Kimi, GLM, etc.) hosted on
          Synthetic.new. Requires a Synthetic.new API key from synthetic.new.
        </p>
      </div>

      <SettingsToggle
        variant="enable"
        name="Enable Synthetic.new"
      ...
      {config.enabled && (
        <>
          <div className="provider-panel-section py-4 mb-4 border-b border-[var(--nim-border)] last:border-b-0 last:mb-0 last:pb-0">
            ...
            <div className="api-key-section mt-4">
              <div className="api-key-row flex gap-2 items-center">
                <input
                  type="password"
                  value={apiKeys.synthetic || ''}
                  onChange={(e) => onApiKeyChange('synthetic', e.target.value)}
          ...
          <div className="provider-panel-section py-4 mb-4 border-b border-[var(--nim-border)] last:border-b-0 last:mb-0 last:pb-0">
            ...
            {!loading && availableModels.length === 0 && apiKeys.synthetic && (
