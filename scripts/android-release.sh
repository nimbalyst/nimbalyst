...
echo "   -> This triggers .github/workflows/android-release.yml, which rebuilds"
echo "      the APK/AAB and publishes them to a GitHub Release for this tag."
echo ""
echo "Note: Google Play upload is intentionally out of scope for now and is"
echo "      deferred to a later phase. This release stops at the GitHub Release."
